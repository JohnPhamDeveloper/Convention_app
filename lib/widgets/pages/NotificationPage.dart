    ...
    return Column(
      children: <Widget>[
        RaisedButton(
            ...
            child: Text("CLICk")),
        StreamBuilder(
          stream: Firestore.instance.collection("users").document('jones').collection('messages').snapshots(),
          builder: (context, snapshot) {
            ...
            return Expanded(
              child: ListView.builder(
                itemCount: snapshot.data.documents.length + 1, // + 1 is for the sized box
